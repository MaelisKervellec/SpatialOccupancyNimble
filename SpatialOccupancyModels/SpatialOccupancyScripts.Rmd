...
In this script, we introduce four occupancy models fitted to simulated data. Among the four models, three incorporate spatial components by utilizing different distance metrics: Euclidean distance, least-cost path (LCP) distance, and commute distance. 
