...
We present in the following document the code to write dynamic occupancy models using nimble (de Valpine et al., 2017). Reproducible examples with simulated data are available on Zenodo XX in the `SpatialOccupancyModels` folder. 
